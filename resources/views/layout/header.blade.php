                            ...
                            <li class="slide">
                                <a class="side-menu__item has-link {{ Request::is('admin/tourists*') ? 'active' : '' }}"
                                    data-bs-toggle="slide" href="{{ url('admin/tourists') }}"><i
                                        class="side-menu__icon fe fe-home"></i><span
                                        class="side-menu__label">Tourists</span></a>
                            </li>

                            <li class="slide">
                                <a class="side-menu__item has-link {{ Request::is('admin/tourguides*') ? 'active' : '' }}"
                                    data-bs-toggle="slide" href="{{ url('admin/tourguides') }}"><i
                                        class="side-menu__icon fe fe-home"></i><span class="side-menu__label">Tour
                                        Guides</span></a>
                            </li>

                            <li class="slide">
                                <a class="side-menu__item has-link {{ Request::is('admin/touroperators*') ? 'active' : '' }}"
                                    data-bs-toggle="slide" href="{{ url('admin/touroperators') }}"><i
                                        class="side-menu__icon fe fe-home"></i><span class="side-menu__label">Tour
                                        Operators</span></a>
                            </li>
